package massimomauro.S7L2BCryptAuthorizationCORS.security;
...
public class JWTTools {
    ...
    public String createToken(User user){
        ...
        String token= Jwts.builder().setSubject(String.valueOf(user.getId()))// Subject <-- A chi appartiene il token
